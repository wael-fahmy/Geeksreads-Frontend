...
constructor(public comments_service: CommentsDetails_Service, public review_service: Bookreviews_Service,
            public book_service: Book_Service) { }
  ngOnInit() {
// tslint:disable-next-line: max-line-length
    this.review_service.get_review_Info(localStorage.getItem('bookID'));                                  // to get the user info from the service
...
// tslint:disable-next-line: max-line-length
    this.book_service.get_book_Info(localStorage.getItem('bookID'));                                  // to get the user info from the service
    // tslint:disable-next-line:variable-name
