...
export class CountBooksService{
    ...
    add_count_read(index:ListOfBooks)           // to update the number of books read 
    {
        ...
        this.http
        .post<{message: string}>("http://localhost:3000/api/posts", index)
    ...
    add_count_want_to_read(index:ListOfBooks)             // to update the number of books want to read 
    {
    ...
    add_count_reading(index:ListOfBooks)             // to update the number of books reading
    {
        
        this.New_num_reading= this.New_num_reading+1;
        this.num_reading_Updated.next(this.New_num_reading);
    }
